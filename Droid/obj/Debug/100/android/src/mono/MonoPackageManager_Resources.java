...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TabbedPageWithNavigationPage.Droid.dll" comes first in this list. */
		"TabbedPageWithNavigationPage.Droid.dll",
		"FormsViewGroup.dll",
		"TabbedPageWithNavigationPage.dll",
